...
app
  ...
  .get(function (req, res) {
    ...
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"> <input class="home" type="text" name="name" id="name"
                placeholder="Plugin Name" required="" aria-required="true"></div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"> <input class="home" type="text" name="slug" id="slug"
                placeholder="Plugin Slug" required="" aria-required="true"></div>
    </div>
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> <input class="home" type="text" name="uri" id="uri"
                placeholder="Plugin Uri" required="" aria-required="true"></div>
    </div>
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"> <input class="home" type="text" name="author[name]"
                id="author-name" placeholder=" Author Name" required="" aria-required="true"></div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"> <input class="home" type="text" name="author[email]"
                id="author-email" placeholder="Author Email" required="" aria-required="true"></div>
    </div>
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"> <input class="home" type="text" name="author[uri]"
                id="author-uri" placeholder="Author Uri" required="" aria-required="true"></div>
    </div>
    <div class="row">
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            <div class="error-form"></div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"> <button type="submit" class="primary pull-right">Build
                Plugin</button></div>
    </div>
</form>`);
  ...
  .post(function (req, res) {
    ...
    fs.copy(origin, destination, function (err) {
      ...
      walker(destination + '/' + pluginSlug, function (err, files) {
        ...
        files.forEach(function (file) {
          var newName;
          var plugin_slug = /plugin-name/gi;
          var plugin_package_name = /Plugin_Name/gi;

          newName = file.match(plugin_slug) ? file.replace(plugin_slug, pluginSlug) : file.replace(plugin_package_name, pluginNamePackage)
          fs.renameSync(file, newName)
        ...
        replace({
          regex: 'PLUGIN_NAME',
          replacement: pluginNameInstance.toUpperCase(),
          paths: [destination + '/' + pluginSlug],
          recursive: true,
          silent: true
        });
...
var getSourceCode = function () {
  var repo = {
    user: 'alvsconcelos',
    repo: 'Composer-WordPress-Plugin-Boilerplate',
    ref: 'master'
  };
